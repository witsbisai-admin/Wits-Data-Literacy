...
function fillFromProfile(){
  ...
  if(s){
    ...
    if(p.name){document.getElementById('cf-name').value=p.name;}
    if(p.role){document.getElementById('cf-role').value=p.role;}
    if(p.faculty){document.getElementById('cf-faculty').value=p.faculty;}
    renderCert();
  }
}
