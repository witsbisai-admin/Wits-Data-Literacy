...
function renderInteractiveLab(uid){
  ...
  async function completeLab(uid){
    ...
    if(!state.completedLabs.includes(uid)){
      ...
      document.getElementById(`lab-done-badge-${uid}`).textContent='✓ Lab Complete';
      document.getElementById(`lab-done-badge-${uid}`).classList.add('completed');
      document.getElementById(`lab-complete-btn-${uid}`).textContent='✓ Lab Completed';
      document.getElementById(`lab-complete-btn-${uid}`).disabled=true;
  ...
  function buildLab1(){
    ...
    <div id="ilab-1" class="ilab-container">
      ...
      <div class="ilab-panel" id="lpanel-1-audit">
        ...
        <button class="lab-complete-btn" id="lab-complete-btn-1" onclick="completeLab(1)" ${labDone(1)?'disabled':''}>
          ${labDone(1)?'✓ Lab Completed':'🏁 Mark Lab Complete (+75 XP)'}
        </button>
      </div>
  ...
  function buildLab2(){
    ...
    <div id="ilab-2" class="ilab-container">
      ...
      <div class="ilab-panel" id="lpanel-2-tasks">
        ...
        <button class="lab-complete-btn" id="lab-complete-btn-2" onclick="completeLab(2)" ${labDone(2)?'disabled':''}>
          ${labDone(2)?'✓ Lab Completed':'🏁 Mark Lab Complete (+75 XP)'}
        </button>
      </div>
    </div>`;
  }
  ...
  function buildLab3(){
    ...
    <div id="ilab-3" class="ilab-container">
      ...
      <div class="ilab-panel" id="lpanel-3-story">
        ...
        <button class="lab-complete-btn" id="lab-complete-btn-3" onclick="completeLab(3)" ${labDone(3)?'disabled':''}>
          ${labDone(3)?'✓ Lab Completed':'🏁 Mark Lab Complete (+75 XP)'}
        </button>
      </div>
    </div>`;
  }
  ...
  async function saveSCQA(){
    state.scqa={s:document.getElementById('scqa-s')?.value||'',c:document.getElementById('scqa-c')?.value||'',q:document.getElementById('scqa-q')?.value||'',a:document.getElementById('scqa-a')?.value||''};
    await saveState();
  }
  ...
  function buildLab4(){
    ...
    <div id="ilab-4" class="ilab-container">
      ...
      <div class="ilab-panel" id="lpanel-4-high">
        ...
        <button class="lab-complete-btn" id="lab-complete-btn-4" onclick="completeLab(4)" ${labDone(4)?'disabled':''}>
          ${labDone(4)?'✓ Lab Completed':'🏁 Mark Lab Complete (+75 XP)'}
        </button>
      </div>
  ...
  function buildLab5(){
    ...
    <div id="ilab-5" class="ilab-container">
      ...
      <div class="ilab-panel" id="lpanel-5-record">
        ...
        <button class="lab-complete-btn" id="lab-complete-btn-5" onclick="completeLab(5)" ${labDone(5)?'disabled':''}>
          ${labDone(5)?'✓ Lab Completed':'🏁 Mark Lab Complete (+75 XP)'}
        </button>
      </div>
    </div>`;
  }
  ...
  async function saveEthicsRecord(){
    state.ethicsRecord={issue:document.getElementById('ethics-issue')?.value||'',principles:document.getElementById('ethics-principles')?.value||'',decision:document.getElementById('ethics-decision')?.value||''};
    await saveState();
  }
  ...
  function buildLab6(){
    ...
    <div id="ilab-6" class="ilab-container">
      ...
      <div class="ilab-panel" id="lpanel-6-plan">
        ...
        <button class="lab-complete-btn" id="lab-complete-btn-6" onclick="completeLab(6)" ${labDone(6)?'disabled':''}>
          ${labDone(6)?'✓ Lab Completed':'🏁 Mark Lab Complete (+75 XP)'}
        </button>
      </div>
    </div>`;
  }
  ...
  async function toggleLabTask(uid,ti){
    ...
    if(idx===-1)state.labTasks[uid].push(ti); else state.labTasks[uid].splice(idx,1);
    await saveState();
